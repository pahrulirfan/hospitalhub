...
@section('content')
    <div class="col-md-6">
        <div class="bg-light p-4 rounded">
            <h6 class="mb-4">Tambah Dokter</h6>
            ...
            <form action="{{ route('dokters.store') }}" method="POST">
                ...
                <div class="mb-3">
                    <label>No STR</label>
                    <input type="text" name="no_str" class="form-control @error('no_str') is-invalid @enderror" value="{{ old('no_str') }}" required>
                ...
                <div class="mb-3">
                    ...
                    <div>
                        ...
                        <label class="ms-3"><input type="radio" name="jenis_kelamin" value="P" {{ old('jenis_kelamin') == 'P' ? 'checked' : '' }}> Perempuan</label>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="spesialisasi_id" class="form-select @error('spesialisasi_id') is-invalid @enderror">
                        ...
                        @foreach($spesialisasis as $sp)
                            <option value="{{ $sp->id }}" {{ old('spesialisasi_id') == $sp->id ? 'selected' : '' }}>
                                {{ $sp->nama }}
                            </option>
                        @endforeach
                    </select>
