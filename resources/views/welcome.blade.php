    ...
    <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
        <div
            ...
            <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                Website sederhana ini dapat digunakan untuk bahan praktikum CRUD data menggunakan mobile kotlin atau
                menggunakan PyQT5
            </p>
            <h4>Silahkan akses <a target="_blank" class="underline" href="https://hospital.lomboktripfinder.com/route-list" >link route</a> untuk melihat endpoint yang tersedia pada website ini</h4>
        </div>
    </main>
</div>
